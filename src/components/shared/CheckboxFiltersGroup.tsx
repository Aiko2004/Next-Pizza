...
export const CheckboxFiltersGroup: React.FC<CheckboxFiltersGroupProps> = ({ title, items, defaultItems, limit=3, searchInputPlaceholder = 'Поиск', className, onChange, defaultValue }) => {
